...
- (void)layoutSubviews {
    ...
    if (nil != self.labelText) {
        ...
        CGRect textRect = [self.labelText boundingRectWithSize:CGSizeMake(100, 100)
                                                      options:NSStringDrawingUsesLineFragmentOrigin
                                                   attributes:@{NSFontAttributeName:self.labelFont}
                                                      context:nil];
        
        CGSize dims=textRect.size;
        //fixed for deprecation
        ...
        if (nil != self.detailsLabelText) {
            ...
            //fixed for deprecation
            CGRect textRect = [self.detailsLabelText boundingRectWithSize:CGSizeMake(100, 100)
                                                           options:NSStringDrawingUsesLineFragmentOrigin
                                                        attributes:@{NSFontAttributeName:self.detailsLabelFont}
                                                           context:nil];
